<x-app-layout>
    <div class="flex flex-wrap flex-row my-3">
        <div class="flex-shrink max-w-full px-4 w-full">
            <p class="text-xl font-bold mt-0 mb-5">Zonal Reports : Divisional Overseer </p>
        </div>
                    ...
                    <div class="flex-shrink max-w-full px-4 w-full">
                        ...
                        <x-app-layout-table.table class="hidden-header hidden-sort-after">
                            <x-app-layout-table.thead>
                                ...
                                <x-app-layout-table.th lablename="Div_Zone" />
                                        ...
                                        <tr>
                                            ...
                                            <x-app-layout-table.td>
                                                <div class="flex">
                                                    ...
                                                    <a href="javascript:;"
                                                        onclick="SumitEdit('View detailed branch for  {{ $report->zone_name }}  {{ $report->report_month }}, {{ $report->report_year }} report ?','/divisional/branch/reports?zone={{$report->zone_id}}&year={{now()->year}}&month={{$report->month_key}}')"
