<x-app-layout>
    <div class="flex-shrink max-w-full px-4 w-full my-3">
        <div class="flex-shrink max-w-full px-4 w-full md:flex md:justify-between">
            <p class="text-xl font-bold mt-0 mb-5">Financial Report</p>
        </div>
        <div class="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg h-full">
            ...
            <div class="md:flex md:justify-between">
                ...
                <div>
                    ...
                    <form method="get" id="generateForm"
                        action="/admin/reports/ajax/finance">
            ...
            <x-app-layout-table.table class="hidden-header hidden-sort-after">
                <x-app-layout-table.thead>
                    <x-app-layout-table.th lablename="Period" />
                    ...
                    <x-app-layout-table.th lablename="1st_Off" />
                    <x-app-layout-table.th lablename="2nd_Off" />
                    <x-app-layout-table.th lablename="Thanksgiving" />
                    <x-app-layout-table.th lablename="Special_Off" />
                    <x-app-layout-table.th lablename="Cell_Off" />
                    <x-app-layout-table.th lablename="Amalgamation" />
                    <x-app-layout-table.th lablename="Total_Off" />
                </x-app-layout-table.thead>
                    ...
                    @if ($reportdata != null)
                        @foreach ($reportdata as $report)
                            <tr>
                                ...
                                @endif
                                <x-app-layout-table.td> {{ $report->currency }} </x-app-layout-table.td>
                                ...
                                <x-app-layout-table.td> @fmoney($report->second_offering) </x-app-layout-table.td>
                                <x-app-layout-table.td> @fmoney($report->thanksgiving)</x-app-layout-table.td>
                                <x-app-layout-table.td> @fmoney($report->special_offering)</x-app-layout-table.td>
                                ...
                                <x-app-layout-table.td> @fmoney($report->total_offering)</x-app-layout-table.td>
