<x-app-layout>
    <div class="flex-shrink max-w-full px-4 w-full my-3">
        <div class="flex-shrink max-w-full px-4 w-full md:flex md:justify-between">
            <p class="text-xl font-bold mt-0 mb-5">LFU Reports</p>
        </div>
        <div class="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg h-full">
            ...
            <x-app-layout-table.table class="hidden-header hidden-sort-after">
                <x-app-layout-table.thead>
                    ...
                    <x-app-layout-table.th lablename="Total Cells" />
                    <x-app-layout-table.th lablename="Cells Met" />
                    <x-app-layout-table.th lablename="Avg Attendance" />
                    <x-app-layout-table.th lablename="Cell Offering" />
                        ...
                        @foreach ($reportdata as $report)
                            <tr>
                                ...
                                <x-app-layout-table.td>
                                    <span class="text-sm text-red-500">{{ $report->currency }}</span>
                                    @fmoney($report->cell_offering)
                                </x-app-layout-table.td>
                            </tr>
                        @endforeach
                    @endif
