<x-app-layout>
    <div class="flex flex-wrap flex-row my-3">
        <div class="flex-shrink max-w-full px-4 w-full">
            <p class="text-xl font-bold mt-0 mb-5">Zonal Reports : Admin</p>
        </div>
                    ...
                    <div class="flex-shrink max-w-full px-4 w-full">
                        ...
                        <div>
                            ...
                            <form method="get" id="generateForm"
                                action="{{ route('admin.exportZonalReports') }}">
                                ...
                                @if ($reports != null)
                                    @foreach ($reports as $report)
                                        <tr>
                                            ...
                                            <x-app-layout-table.td>{{ $report->branch_visited }}  </x-app-layout-table.td>
