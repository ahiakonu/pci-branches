    ...
    <div x-data="{ open: false }" class="wrapper overflow-x-hidden bg-gray-100 dark:bg-gray-900 dark:bg-opacity-40">
        ...
        <div x-bind:aria-expanded="open"
            ...
            <main class="pt-20 -mt-2">
                ...
                {{-- Breadcrumb --}}
                {{--  <div
                    class="px-8 border border-gray-200 dark:bg-gray-900 dark:bg-opacity-20 dark:border-gray-800">
                            ...
                            <li>
                                <a href="#" class="hover:text-indigo-500">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        class="mx-1 transform ltr:rotate-0 rtl:rotate-180 inline-block" width="1rem"
